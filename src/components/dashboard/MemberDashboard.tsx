...
const MemberDashboard = () => {
  ...
  const loadData = async () => {
    ...
    setLoading(true);
    try {
      const [metricsResult, tradesResult, summaryResult, leaderboardResult] =
        await Promise.all([
  ...
  const renderContent = () => {
    switch (activeSection) {
          ...
          <div className="space-y-6">
            <div className="mb-6">
              ...
              <p className="text-muted-foreground">
                Manage your PLANT metrics, trades, and business networking
                activities
              </p>
            </div>
            <MetricsChart
      ...
      case "reports":
        return (
          <ReportsPanel metrics={metrics} trades={trades} summary={summary} />
        );
      default:
        return null;
    }
