...
const AuditTrail: React.FC = () => {
  ...
  const getActionIcon = (action: string) => {
    ...
    if (action.includes("trade") || action.includes("payment"))
  ...
  const getActionBadge = (action: string) => {
    if (action.includes("created"))
      return (
        <Badge className="bg-success text-success-foreground">Created</Badge>
      );
  ...
  const getSeverityLevel = (action: string) => {
    if (action.includes("deleted") || action.includes("password_reset"))
      return "high";
  ...
  return (
    <div className="space-y-6">
        ...
        <Card>
          ...
          <CardContent>
            <div className="text-2xl font-bold text-destructive">
              {
                filteredLogs.filter(
                  (log) => getSeverityLevel(log.action) === "high"
                ).length
              }
            </div>
      ...
      <Card>
        <CardHeader>
          <CardTitle>Audit Logs ({totalCount.toLocaleString()})</CardTitle>
          <CardDescription>
            ...
            <>
                          ...
                          {(log.new_values || log.old_values) && (
                            <Button
                              ...
                              onClick={() => {
                                ...
                                toast.info(
                                  "Audit log details logged to console"
                                );
                              }}
                            >
              ...
              <div className="flex items-center justify-between mt-4">
                <div className="text-sm text-muted-foreground">
                  ...
                  {Math.min(currentPage * 20, totalCount)} of {totalCount} logs
                </div>
                <div className="flex items-center gap-2">
                  <Button
                    variant="outline"
