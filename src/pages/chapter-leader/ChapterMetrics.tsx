      ...
      <div className="p-4 md:p-6 space-y-6">
          ...
          <Card className="border-border">
            ...
            <CardContent>
              <div className="text-2xl font-bold text-success">
                {stats?.avgParticipation.toFixed(1) || "0.0"}
              </div>
        ...
        <Card className="border-border">
          <CardHeader>
            ...
            <CardDescription>
              Monitor PLANT metrics across your chapter members
            </CardDescription>
          </CardHeader>
          <CardContent>
            <div className="space-y-6">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4 pt-6 border-t border-border">
                ...
                <div className="space-y-2">
                  ...
                  <div className="flex items-center justify-between text-sm">
                    ...
                    >
                      {stats?.monthlyGrowth.learningHours > 0 ? "+" : ""}
                      {stats?.monthlyGrowth.learningHours.toFixed(1)}%
                    </Badge>
                  </div>
                </div>
              </div>
              ...
              <div className="pt-4 border-t border-border">
                <p className="text-sm text-muted-foreground">
                  Metrics are updated in real-time and reflect member activity
                  across all PLANT categories. Use this data to identify
                  engagement patterns and support member growth.
                </p>
              </div>
            </div>
          </CardContent>
