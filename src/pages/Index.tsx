...
import { TrendingUp, Users, GraduationCap, Activity, Network, DollarSign } from 'lucide-react';
  ...
  const features = [
    {
      ...
      description: 'Monitor attendance, punctuality, and consistency across all meetings and events.'
    },
    {
      icon: GraduationCap,
      title: 'Learning Management',
      description: 'Track study hours, mentorship sessions, and training engagement.'
    },
    {
      icon: Activity,
      title: 'Activity Monitoring',
      description: 'Record referrals given and received, plus chapter involvement activities.'
    },
    {
      icon: Network,
      title: 'Networking Analytics',
      description: 'Track one-on-one meetings and partnerships created within your network.'
    },
    {
      icon: DollarSign,
      title: 'Trade Management',
      description: 'Monitor business passed, deals closed, and transaction values with integrated payments.'
    }
  ];
      ...
      <div className="container mx-auto px-4 py-16">
        <div className="text-center mb-16">
          ...
          <p className="text-xl md:text-2xl text-muted-foreground mb-8 max-w-3xl mx-auto">
            Track your business network growth with comprehensive PLANT metrics tracking, 
            real-time leaderboards, and integrated payment management.
          </p>
        ...
        <Card className="max-w-4xl mx-auto">
          <CardHeader className="text-center">
            ...
            <CardDescription>
              A comprehensive business networking framework for tracking success metrics
            </CardDescription>
          </CardHeader>
          <CardContent>
            <div className="grid grid-cols-1 md:grid-cols-5 gap-4">
              <div className="text-center">
                <div className="w-12 h-12 bg-participation/20 rounded-full flex items-center justify-center mx-auto mb-2">
                  <span className="text-xl font-bold text-participation">P</span>
                </div>
                <h3 className="font-semibold">Participation</h3>
                <p className="text-sm text-muted-foreground">Attendance & Engagement</p>
              </div>
              <div className="text-center">
              ...
              <div className="text-center">
                ...
                <p className="text-sm text-muted-foreground">Referrals & Involvement</p>
              </div>
              <div className="text-center">
                ...
                <p className="text-sm text-muted-foreground">Meetings & Partnerships</p>
              </div>
              <div className="text-center">
